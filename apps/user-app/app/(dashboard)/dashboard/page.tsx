...
async function getBalance() {
  try {
    ...
    console.log("Database error in getBalance: ", error);
...
async function getUser() {
  try {
    ...
    console.log("Database error in getUser: ", error);
    throw new Error("Network-failed");
  }
}
  ...
  try {
              ...
              <div className="flex flex-col justify-around">
                <div className="w-fit h-fit lg:min-w-72 my-2 flex p-5 py-5 flex-col rounded-2xl mr-5 bg-neutral-100">
                  <div className="border-b-2 border-neutral-300 pb-2">
                    ...
                    <div className="flex pt-2 px-2 justify-between items-center">
                      ...
                      <div className="text-green-700">+390</div>
                    </div>
                  </div>
                ...
                <div className="bg-neutral-100 my-2 justify-between flex p-5 min-w-72 w-fit rounded-2xl ">
                  <div>
                    ...
                    <h1 className="text-2xl font-semibold pt-2 px-2">
          ...
          <div className="col-span-2 row-span-2 bg-neutral-100 px-3 py-4 rounded-2xl">
            ...
            <div className="my-5">
              ...
              <div className=" flex py-4 rounded-2xl my-4 px-3 bg-blue-100 justify-around">
                <div>
                  <div className="rounded-full bg-neutral-200 flex w-fit box-content p-4">
                    AY
                  </div>
    ...
    if (error.message === "Network-failed") {
      return (
        <div className="w-full h-96 flex justify-center items-center">
          <div className="bg-red-100 text-red-700 px-5 py-3 rounded-lg shadow-md text-center">
            <h1 className="text-lg font-semibold">Your Network is down</h1>
            <p className="text-sm">
    ...
    return (
        <div className="w-full h-full flex justify-center items-center">
          <div className="bg-red-100 text-red-700 px-5 py-3 rounded-lg shadow-md text-center">
            <h1 className="text-lg font-semibold">Unexpected error occured.</h1>
            <p className="text-sm">
