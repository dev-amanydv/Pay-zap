      ...
      <div>
        <section className="text-white py-24  w-full font-bold">
          <div className="flex flex-col items-center">
            <div className="w-full text-center justify-center bg-gradient-to-r from-blue-900 via-neutral-500  to-blue-950 bg-clip-text text-transparent items-center pb-0 text-[24px] text-[#B8B8BC]">
            ...
            <div className="w-full flex bg-gradient-to-r from-neutral-300 via-neutral-400  to-blue-100 bg-clip-text text-transparent  justify-center gap-2 text-center pb-5 text-[42px] text-gray-100 items-center">
          ...
          <div className="w-full relative pt-20 flex pr-20 justify-center rounded-lg overflow-hidden items-center">
            <Image src="/hero3.svg" className="opacity-70" alt="hero" width={1000} height={1000} />
          </div>
        </section>
        <section className="text-white p-8 w-full">
          <div className="text-center my-10 w-fit mx-auto px-5 rounded-full text-md border-2 border-slate-400">Features</div>
          <div className="grid grid-cols-5 gap-10">
            <div className=" bg-slate-800 relative flex overflow-hidden text-white shadow-lg rounded-3xl  col-span-3">
                ...
                <h1 className="text-2xl w-96 absolute bottom-1/4 opacity-70 font-bold max-w-lg pl-5 bg-gradient-to-r from-neutral-100 via-neutral-200 to-neutral-100 bg-clip-text text-transparent">Instant Money Transfer with UPI/QR</h1>
                <p className="text-sm w-3/4 text-neutral-500 absolute pl-6 bottom-9">Send and receive money instantly via UPI or by scanning any QR code — fast, secure, and hassle-free.</p>
            </div>
            <div className="bg-slate-800 overflow-hidden relative p-6 text-white shadow-lg rounded-3xl h-96 col-span-2">
                ...
                <h1 className="text-2xl w-96 absolute bottom-1/4 opacity-70 font-bold max-w-lg bg-gradient-to-r from-neutral-100 via-neutral-200 to-neutral-100 bg-clip-text text-transparent">One Tap Bill Payments and Recharges</h1>
                <p className="text-sm w-3/4 text-neutral-500 absolute  bottom-6">Send and receive money instantly via UPI or by scanning any QR code — fast, secure, and hassle-free.</p>
            </div>
            <div className="bg-slate-800 p-6 overflow-hidden relative text-white shadow-lg rounded-3xl h-96 col-span-2">
              ...
              <div className="absolute top-0 left-0 h-3/4 w-full bg-[linear-gradient(to_top,_rgba(0,0,0,1),_rgba(0,0,0,0))] pointer-events-none"></div> 
                ...
                <h1 className="text-2xl w-96 absolute bottom-1/4 opacity-70 font-bold max-w-lg bg-gradient-to-r from-neutral-100 via-neutral-200 to-neutral-100 bg-clip-text text-transparent">Split Payments with Friends</h1>
                <p className="text-sm w-3/4 text-neutral-500 absolute  bottom-6">Split restaurant bills, rent, or any group expense and track who paid what — perfect for students and roommates.
                </p>
            </div>
            <div className="bg-slate-800 overflow-hidden p-6 relative text-white shadow-lg rounded-3xl h-96 col-span-3">
               ...
               <div className="absolute top-0 left-0 h-3/4 w-full bg-[linear-gradient(to_top,_rgba(0,0,0,1),_rgba(0,0,0,0))] pointer-events-none"></div> 
                ...
                <h1 className="text-2xl absolute bottom-1/4 opacity-70 font-bold w-96 bg-gradient-to-r from-neutral-100 via-neutral-200 to-neutral-100 bg-clip-text text-transparent">Virtual Cards for Online Payments</h1>       
                <p className="text-sm w-3/4 text-neutral-500 absolute  bottom-9">Generate secure, app-linked virtual cards for safer online shopping without exposing your bank details.</p>
            </div>
          </div>
        </section>
